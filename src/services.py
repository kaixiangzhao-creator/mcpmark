    ...
    "playwright_webarena": {
        "config_schema": {
            ...
            "state_root": {
                ...
                "default": "/srv/mcpmark-state",
                "required": False,
                "description": "Root containing baselines/ and per-task runs/",
            },
            "snapshot_driver": {
                "env_var": "WEBARENA_SNAPSHOT_DRIVER",
                "default": "reflink",
                "required": False,
                "description": "Snapshot driver: reflink or copy",
                "validator": "in:reflink,copy",
            },
            "runtime_registry": {
                "env_var": "WEBARENA_RUNTIME_REGISTRY",
                "default": "",
                "required": False,
                "description": "Optional registry prefix for slim runtime images",
            },
            "media_mode": {
                "env_var": "WEBARENA_MEDIA_MODE",
                "default": "readonly",
                "required": False,
                "description": "Media handling: readonly shared baseline or COW clone",
                "validator": "in:readonly,cow",
            },
            "reset_timeout": {
                "env_var": "WEBARENA_RESET_TIMEOUT",
                "default": 300,
                "required": False,
                "description": "Seconds allowed for state preparation and readiness",
                "transform": "int",
            },
            "keep_failed_state": {
                "env_var": "WEBARENA_KEEP_FAILED_STATE",
                "default": False,
                "required": False,
